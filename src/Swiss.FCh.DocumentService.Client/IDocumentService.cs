...
public interface IDocumentService
{
    ...
    Task<Stream> CreateWordFromTemplate(string templateFilePath, object data, string? docRootElementName = null, string? documentCulture = null);
    Task<Stream> CreatePdfFromTemplate(string templateFilePath, object data, string? docRootElementName = null, string? documentCulture = null);
