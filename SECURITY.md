...
The fch-documentservice-client maintainers take security issues seriously, and we appreciate your efforts to responsibly disclose
any findings. Please DO NOT disclose potential issues publicly until we've had a chance to fix it.

To report a security issue, please use the GitHub Security Advisory
["Report a Vulnerability"](https://github.com/swiss/fch-documentservice-client/security/advisories/new) feature.

The fch-documentservice-client maintainers will respond with the next steps for handling your report. After the initial reply, the maintainers
